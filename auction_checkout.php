            ...
            <div class="col-sm-12">
               ...
               <div class="row">
                  <div class="col-sm-6">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <strong class="col-sm-12">Contactless payment is a very safe process. Just take a picture of the code, enter the amount and confirm.</strong>
                           ...
                           <div class="radio col-md-3 col-sm-3"  style="margin-top: 10px;">
                              <label>
                              <input type="radio" onclick="payment_method();" name="payment_method" value="<?php echo $v6["apm_id"]; ?>"  ><?php echo $v6["apm_name"]; ?></label>
                           </div>
                           <?php
                              }
                              ?>
                              
                                <div class="radio col-md-6 col-sm-6" style="margin-top: 10px;">
                              <label>
                  ...
                  <div class="col-sm-6">
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4 class="panel-title"><i class="fa fa-credit-card"></i>Price</h4>
                        </div>
                        <div class="panel-body">
