...
//print_r($_POST);
$category=trim($_POST["category_id1"]);
$sub_cat="";
...
?>							
                    ...
                    if($page != 1){
                      $prev=$page-1;
                    ?>
                    <li><a href="javascript:void(0);" onclick="ajax_get_pagination('<?php echo $category; ?>','<?php echo $sub_cat; ?>','<?php echo $min_price; ?>','<?php echo $max_price; ?>','<?php echo $color; ?>',1);" title="First"><i class="fa fa-angle-double-left"></i></a></li>
                    <li><a href="javascript:void(0);" onclick="ajax_get_pagination('<?php echo $category; ?>','<?php echo $sub_cat; ?>','<?php echo $min_price; ?>','<?php echo $max_price; ?>','<?php echo $color; ?>','<?php echo $prev; ?>');" ><i class="fa fa-chevron-left"></i></a></li>
                    <?php
                    }
                   ?>
                   <!-- new -->
...
for($p=$s;$p<$page;$p++){
  if($p!=$page){
?>
<li><a href="javascript:void(0);"   onclick="ajax_get_pagination('<?php echo $category; ?>','<?php echo $sub_cat; ?>','<?php echo $min_price; ?>','<?php echo $max_price; ?>','<?php echo $color; ?>','<?php echo $p; ?>');" ><?php echo $p;  ?></a></li>
<?php
}else{
?>
...
if($l==4){
  break;
                    ...
                    if($page < $total_page){
                      $next=$page+1;
                      ?>
                      <li><a href="javascript:void(0);" onclick="ajax_get_pagination('<?php echo $category; ?>','<?php echo $sub_cat; ?>','<?php echo $min_price; ?>','<?php echo $max_price; ?>','<?php echo $color; ?>','<?php echo $next; ?>');"><i class="fa fa-chevron-right"></i></a></li>
                      <li><a href="javascript:void(0);" onclick="ajax_get_pagination('<?php echo $category; ?>','<?php echo $sub_cat; ?>','<?php echo $min_price; ?>','<?php echo $max_price; ?>','<?php echo $color; ?>','<?php echo $total_page; ?>');" title="Last"><i class="fa fa-angle-double-right"></i></a></li>
                      <?php
                      }
                      ?>
                    </ul>	
