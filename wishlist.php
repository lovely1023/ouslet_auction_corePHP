            ...
            <table class="table table-bordered table-hover" id="datatable2">
               <thead>
                  <tr>
                     ...
                     <td class="text-right"><?php echo $lang_90; ?></td>
                     <td class="text-right"><?php echo $lang_38; ?></td>
                     <td class="text-right"><?php echo $lang_138; ?></td>
                  </tr>
               </thead>
               <tbody>
                  <?php
                 	 ...
                 	 ?>						
		                  <tr>
		                     ...
		                     <td class="text-center">
		                        <a  href="product.php?id=<?php echo $v["aaw_apa_id"] ?>"><img width="70px" src="vendor/product_photo/<?php echo $cart_image; ?>" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop">
		                        </a>
		                     </td>
		                     <td class="text-left"><a href="product.php?id=<?php echo $v["aaw_apa_id"] ?>"><?php echo getProductName($v["aaw_apa_id"]);  ?></a>
		                     </td>
		                     <td class="text-right"><?php echo $v["stock"]; ?></td>
		                     <td class="text-right">
		                        <?php
