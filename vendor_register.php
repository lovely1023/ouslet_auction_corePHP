	...
	$("#ajax_des").on('submit',(function(e){  
		...
		$.ajax({
				...
				if(data==1){
					...
					//alert("Please check Email To login");
				...
				<form action="javascript:void(0);" method="post" enctype="multipart/form-data" class="form-horizontal account-register clearfix" id="ajax_des">
					<fieldset id="account">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="fname" id="fname" value="" placeholder="<?php  echo $lang_111; ?>" id="input-firstname" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-lastname"><?php  echo $lang_112; ?></label>
							<div class="col-sm-10">
								<input type="text" name="lname" id="lname" value="" placeholder="<?php  echo $lang_112; ?>" id="input-lastname" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-email"><?php  echo $lang_113; ?></label>
							<div class="col-sm-10">
								<input type="email" name="email" id="email" value="" placeholder="<?php  echo $lang_113; ?>" id="input-email" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-telephone"><?php  echo $lang_130; ?></label>
							<div class="col-sm-10">
								<input type="tel" name="phone" id="phone" value="" placeholder="<?php  echo $lang_130; ?>" id="input-telephone" class="form-control">
							</div>
						</div>
						<!-- <div class="form-group">
							<label class="col-sm-2 control-label" for="input-fax"><?php  echo $lang_131; ?></label>
							<div class="col-sm-10">
								<input type="text" name="fax" id="fax" value="" placeholder="<?php  echo $lang_131; ?>" id="input-fax" class="form-control">
							</div>
						</div> -->
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-fax"><?php  echo $lang_132; ?></label>
							<div class="col-sm-10">
								<input type="file" name="image" id="image" value=""  id="input-fax" class="form-control">
							</div>
						</div>
					</fieldset>
					<fieldset id="address4">
						<legend><?php  echo $lang_114; ?></legend>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-company"><?php  echo $lang_133; ?></label>
							<div class="col-sm-10">
								<input type="text" name="company" id="company" value="" placeholder="<?php  echo $lang_133; ?>" id="input-company" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-address-1"><?php  echo $lang_134; ?></label>
							<div class="col-sm-10">
								<input type="text" name="address_one" id="address_one" value="" placeholder="<?php  echo $lang_134; ?>" id="input-address-1" class="form-control">
							</div>
						</div>
						...
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-zone"><?php  echo $lang_136; ?></label>
							<div class="col-sm-10">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="post_code" id="post_code" value="" placeholder="<?php  echo $lang_119; ?>" id="input-postcode" class="form-control">
							</div>
						</div>
					...
					<fieldset>
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="password" name="password" id="password" value="" placeholder="<?php  echo $lang_76; ?>" id="input-password" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-confirm"><?php  echo $lang_121; ?></label>
							<div class="col-sm-10">
								<input type="password" name="cpassword" id="cpassword" value="" placeholder="<?php  echo $lang_121; ?>" id="input-confirm" class="form-control">
							</div>
						</div>
					</fieldset>
					...
					<div class="buttons">
						<div class="pull-right"><?php  echo $lang_122; ?> <a href="terms_condition.php" class="agree"><b><?php  echo $lang_123; ?></b></a>
							<input class="box-checkbox" type="checkbox" name="terms_agree" id="check_id" value="1"> &nbsp;
