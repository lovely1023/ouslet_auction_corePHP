...
<div class="main-container container">
   <ul class="breadcrumb">
      ...
      <li><a href="<?php  echo $_SERVER["REQUEST_URI"]; ?>">Won auction</a></li>
   </ul>
   <div class="row">
      <!--Middle Part Start-->
            ...
            <div class="product-layout col-md-3 col-sm-6 col-xs-12 ">
               <div class="product-item-container">
                  <div class="left-block">
                     ...
                     <!--Sale Label-->
                     <span class="label label-sale">Sold</span>
                  </div>
                  <div class="right-block">
                     <div class="caption">
                        ...
                        <span class="label label-percent">Auction Price : 
                        	<?php 
                     ...
                     <div class="button-group">
                        ...
                        <button onclick="auction_checkout('<?php echo $v["apa_id"]; ?>','<?php echo $v5["id"]; ?>','<?php echo $v5["cus_id"]; ?>','<?php echo $auction_price; ?>');" style="background-color: #3498db;width:100%;" class="addToCart" type="button" data-toggle="tooltip"  ><i class="fa fa-gavel fa-2x"></i> <span class="">Purchase Product</span></button>
                     </div>
                  </div>
                  <!-- right block -->
               </div>
