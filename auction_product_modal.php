      ...
      <link rel="stylesheet" type="text/css" href="js/plugins/datatables/media/css/dataTables.bootstrap.css">
      <link rel="stylesheet" type="text/css" href="js/plugins/datatables/extensions/Editor/css/dataTables.editor.css">
      <link rel="stylesheet" type="text/css" href="js/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h2 class="modal-title" id="myModalLabel" style = "text-align:center; font-weight: bold; font-size:22px;  color:#bd0000;">Bid history</h2>
         </div>
                           ...
                           <table class="table table-bordered table-hover">
                              <thead>
                                 <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle">Bid ID</td>
                                    <td class="text-center" style="vertical-align: middle">Last Bid</td>
                                    <td class="text-center" style="vertical-align: middle">Auction Status</td>
                                    <td class="text-center" style="vertical-align: middle">Bidder</td>
                                    <td class="text-center" style="vertical-align: middle">Date and time of bid</td>
                                 </tr>
                              </thead>
                              <tbody>
                                 <?php
...
<div class="modal fade" id="auctioneer_list" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h2 class="modal-title" id="myModalLabel" style = "text-align:center; font-weight: bold; font-size:22px;  color:#bd0000;">List of Auctioneers</h2>
         </div>
         <div class="modal-body" style="min-height: 100px; font-family:serif;  /*font-size: 22px; color: green;*/">
           	<!-- Main Container  -->
			<div class="main-container container">				
					...
					<div id="content" class="col-sm-12">
							...
							<div class="table-responsive">
								<table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
									<thead>
										<tr>
										<th class="va-m">Nickname</th>
										<th class="va-m">Country</th>
										<th class="va-m">City</th>
										<th class="va-m">Number of Transcations</th>
										</tr>
									</thead>
									<tbody>
										<?php
...
<div class="modal fade" id="product_by_seller" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h2 class="modal-title" id="myModalLabel" style = "text-align:center; font-weight: bold; font-size:22px;  color:#bd0000;">All offers from the seller</h2>
         </div>
         <div class="modal-body" style="min-height: 100px; font-family:serif;">
         	<h3 style="color: green; font-weightbold;">Seller : <span style="color:blue;">
         	<?php 
	           ...
	           <table class="table table-bordered table-hover"  id="datatable2" >
	              <thead>
	                 <tr>
	                    ...
	                    <td class="text-left" style="vertical-align: middle">Product Name</td>
	                    <td class="text-center" style="vertical-align: middle">Price</td>
	                    <td class="text-center" style="vertical-align: middle">Start Date</td>
	                    <td class="text-center" style="vertical-align: middle">End Date</td>
	                 </tr>
	              </thead>
	              <tbody>
	                 <?php
...
<div class="modal fade" id="similar_auction_products" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
            <h2 class="modal-title" id="myModalLabel" style = "text-align:center; font-weight: bold; font-size:22px;  color:#bd0000;">Show similar auction products</h2>
         </div>
         <div class="modal-body" style="min-height: 100px; font-family:serif;">
         <?php
         ...
         ?>
         	<h3 style="color: green; font-weightbold;">Category : <span style="color:blue;">
         	<?php 
         	$category_str = '';
         	if($category > 0){
...
<script src="js/plugins/datatables/media/js/jquery.dataTables.js"></script>
<script src="js/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js"></script>
<script src="js/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js"></script>
<script src="js/plugins/datatables/media/js/dataTables.bootstrap.js"></script>
