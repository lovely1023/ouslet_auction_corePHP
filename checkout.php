            ...
            <div class="col-sm-12">
               <div class="row">
                  <div class="col-sm-9">
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4 class="panel-title"><i class="fa fa-credit-card"></i> <?php echo $lang_36;  ?></h4>
                        </div>
                        <div class="panel-body">
                           <p><?php echo $lang_37;  ?></p>
                           <strong>Contactless payment is a very safe process. Just take a picture of the code, enter the amount and confirm.</strong>
                           <?php
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4 class="panel-title"><i class="fa fa-shopping-cart"></i> <?php echo $lang_25;  ?></h4>
                        </div>
                        <div class="panel-body">
                           <div class="table-responsive">
                              <table class="table table-bordered">
                                 ...
                                 <tfoot>
                                    <tr>
                                       <td class="text-right" colspan="4"><font color="red"><strong><?php echo $lang_39;  ?>:</strong></font></td>
                                       <td class="text-left" width="200px">
                                          <div class="input-group btn-block quantity">
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-default col-sm-6" style="padding-left:0px; padding-right:0px;">
                        ...
                        <div class="panel-body">
                           <label for="input-coupon" class="col-sm-3 control-label"><?php echo $lang_41;  ?></label>
                  ...
                  <div class="col-sm-12" id="qrcode_confirm">
                     ...
                     <div class="row">
                     	<a href="cart.php" class="btn btn-primary" style="right:0px !important; bottom:20px !important;position: absolute; ">Return to my account</a>
                     </div>
                  </div>
                  <div class="col-sm-12" id="pay_confirm">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <span><?php echo $lang_122;  ?> <a class="agree" href="terms_condition.php"><b><?php echo $lang_123;  ?></b></a></span> </label>
                           <?php  
