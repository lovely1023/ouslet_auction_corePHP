...
?>
					...
					<div class="contacts-form">
						...
						<div class="buttons clearfix"><a id="button-review" class="btn buttonGray" onclick="submit_vendor_review('<?php echo $_GET["id"]; ?>');">Continue</a></div>
					</div>
				</form>
			</div>
...
?>
					...
					<div class="contacts-form">
						...
						<div class="buttons clearfix"><a id="button-review" class="btn buttonGray" onclick="submit_vendor_question('<?php echo $_GET["id"]; ?>');">Continue</a></div>
					</div>
				</form>
			</div>
		</div>
