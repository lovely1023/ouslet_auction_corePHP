...
<div class="module tab-slider titleLine">
   <h3 class="modtitle"><?php echo $lang_2; ?></h3>
            ...
            <div class="ltabs-items <?php if($k3==0) echo "ltabs-items-selected";  ?> items-category-<?php echo $v3["pc_id"];  ?> grid" data-total="10">
               <div class="ltabs-items-inner ltabs-slider ">
                  <?php
                     ...
                     $condition=array("status"=>1,"keep_in"=>1,"category"=>$v3["pc_id"],"posting_type"=>0);
                     $con1=array();
                     if($vr_id !=0){
                           ...
                           <div class="product-image-container second_img ">
                              <?php
                                 ...
                                 foreach($image as $k1=>$v1){
                                 	$cart_image=$v1["image"];
                                 ?>	
                             		 <img src="vendor/product_photo/<?php echo $cart_image; ?>"  alt="Apple Cinema 30&quot;" class="img-responsive" />
