...
function delete_forbuyers(id){
	 $.post("delete_blog.php",{id:id},function(r){
	 $("#ajax").html(r);
	 });
}
...
<?php
$about=getDetails(doselect1("content,id","blog",array()));
?>
<span class="panel-title">
Blog &nbsp <?php if(!empty($about)) { ?> <a href="javascript:void(0);" title="Edit" onclick="edit_forbuyers('<?php echo $about[0]["id"];  ?>');"><img src="icon/edit.png" width="15" /></a><?php } ?>
</span>
</div>
