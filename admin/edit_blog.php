...
<?php
$about=getDetails(doselect1("content,id","blog",array("id"=>$_POST["id"])));
?>
...
<textarea name="content" id="about" placeholder="Update Blog.........." rows="10" cols="100" style="width: 939px; height: 247px;"><?php echo $about[0]["content"];  ?></textarea>
</label>
</div>
