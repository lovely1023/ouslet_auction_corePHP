         ...
         <div class="mw1000 center-block">
            <div class="allcp-form">
               <div class="panel">
                  ...
                  <?php
                     if(isset($_GET["id"])){
                     $select="apa_id,apa_vr_id,name,category,sub_cat,sub_sub_cat,features,description,weight,color,brand,size,price,stock,video,status,keep_in,posting_type,reserve_price,listing_duration,currency, new_flag, warranty_flag, warranty_long, original_flag, auth_flag";
                     ...
                     <form method="post" action="javascript:void(0);" id="ajax_des" enctype="multipart/form-data">
                        ...
                        <div class="row add_feat1">
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field prepend-icon">
                                 <input type="text" name="weight[]" id="weight" class="gui-input" placeholder="<?php echo $lang_53;  ?>" value="<?php echo $weights_detls[0]; ?>" >
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                        ...
                        <div class="row add_feat3">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field prepend-icon">
                                 <input type="text" name="size[]" id="size" class="gui-input" placeholder="<?php echo $lang_96;  ?>" value="<?php echo $size_details[0]; ?>" >
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="section">
                                 ...
                                 <?php
                                    ...
                                    ?>
                                 <input type="text" name="price[]" id="price" class="gui-input" placeholder="Price" value="<?php echo $price[0];  ?>" >
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="price[]" id="discount" class="gui-input" placeholder="<?php echo $lang_167;  ?>" value="<?php echo $price[2];  ?>" >
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="price[]" id="shipping" class="gui-input" placeholder="<?php echo $lang_168;  ?>" value="<?php echo $price[3];  ?>" >
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="row" style="margin-bottom:10px;">
                           <div id="ajax_select_type" <?php if($v6["posting_type"]==0){ ?> style="display:none;" <?php } ?> >
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 Reserve price :
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="reserve_price" value="<?php echo $v6['reserve_price']; ?>" id="reserve_price" class="gui-input" placeholder="Reserve Price">
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="listing_duration" value="<?php echo $v6['listing_duration']; ?>" id="listing_duration" class="gui-input" placeholder="Listing Duration">
                                    </label>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row" >
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="stock" id="stock" class="gui-input" value="<?php echo $v6["stock"];  ?>">
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-6">
