...
<?php
if(isset($_GET["id"])){
$select="apa_id,apa_vr_id,name,category,sub_cat,sub_sub_cat,features,description,weight,color,brand,size,price,status,currency";
...
echo 'Total Price : '.currency1($v["currency"],$price[0]).'<br/>Tax : '.currency1($v["currency"],$price[1]).'<br/>Discount : '.currency1($v["currency"],$price[2]).'<br/>Shipping Cost : '.currency1($v["currency"],$price[3]);
?></td>
</tr>
<?php
}
