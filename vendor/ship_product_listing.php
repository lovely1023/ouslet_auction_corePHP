...
<?php  echo $lang_187; ?>
<?php
$result=getDetails(doSelect("ass_id,ass_apa_id,cancel_status,ass_ac_id,ass_vr_id,date,shipment_status,quantity","ambit_shipment_status",array("ass_vr_id"=>$_SESSION["vendor_id"])));
