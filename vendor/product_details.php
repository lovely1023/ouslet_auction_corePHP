...
echo 'Total Price : '.currency1($v["currency"],$price[0]).'<br/>Tax : '.currency1($v["currency"],$price[1]).'<br/>'.$lang_39.' : '.currency1($v["currency"],$price[2]).'<br/>'.$lang_168.' : '.currency1($v["currency"],$price[3]);
?></td>
</tr>
<?php
}
