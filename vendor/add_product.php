...
<section id="content_wrapper">
   ...
   <script type="text/javascript">
      function select_type(){
      	...
      	if(posting_type==0){
      		$("#reserve_price").val('0');
      		$("#listing_duration").val('0000-00-00');
                       ...
                       <div class="row">
                        ...
                        <div class="row add_feat1">
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field prepend-icon">
                                 <input type="text" name="weight[]" id="weight" class="gui-input" placeholder="<?php //echo $lang_53; ?>">
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                        ...
                        <div class="row add_feat3">
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field prepend-icon">
                                 <input type="text" name="size[]" id="size" class="gui-input" placeholder="<?php //echo $lang_96; ?>">
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                              ...
                              <div class="section">
                                 <label class="field select">
                                    <select id="posting_type" onchange="select_type();" name="posting_type" >
                                       <option value="0" selected >Only for sale</option>
                                       <option value="1">For auction</option>
                                    </select>
                                    <i class="arrow"></i>
                                 </label>
                              </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="price[]" id="price" class="gui-input" placeholder="<?php //echo $lang_47; ?>">
                                 </label>
                              </div>
                           </div>
                           <!-- <div class="col-md-4">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="price[]" id="discount" class="gui-input" placeholder="<?php //echo $lang_167; ?>">
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="price[]" id="shipping" class="gui-input" placeholder="<?php //echo $lang_168; ?>">
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="row" style="margin-bottom:10px;">
                           <div id="ajax_select_type" style="display:none;">
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="reserve_price" value="0" id="reserve_price" class="gui-input" placeholder="">
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="listing_duration" value="0000-00-00" id="listing_duration" class="gui-input" placeholder="">
                                    </label>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="text" name="stock" id="stock" class="gui-input" placeholder="<?php //echo $lang_169; ?>">
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-6">
