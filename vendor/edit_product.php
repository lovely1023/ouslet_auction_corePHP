                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 ...
                                 <?php
                                    ...
                                    ?>
                                 <input type="text" name="price[]" id="price" class="gui-input" placeholder="" value="<?php echo $price[0];  ?>" >
                                 </label>
                              </div>
                           </div>
                           <!-- <div class="col-md-6">
                        ...
                        <div class="row" style="margin-bottom:10px;">
                           <div id="ajax_select_type" <?php if($v6["posting_type"]==0){ ?> style="display:none;" <?php } ?> >
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="reserve_price" value="<?php echo $v6['reserve_price']; ?>" id="reserve_price" class="gui-input" placeholder="">
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-6" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
