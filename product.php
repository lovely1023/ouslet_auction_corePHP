               ...
               <div class="row">
                  ...
                  <div class="content-product-right col-sm-6 col-xs-12">
                     ...
                     <div class="box-review form-group">
                        ...
                        &nbsp;|&nbsp; <span style="">Number of views: <?php echo $v["view_count"];?></span>
                     </div>
                     <div class="product-label form-group">                     
                        ...
                        <?php 
                        			...
                        			echo ' <br/> <button class="label label-percent" style="line-height:16px;border-style:none;">Last Bid : '.higest_bid($v["apa_id"]).' <br/> Bidder: '.$nick_name.'</button>';
                        		}
                           }
                           ?>
                        <div class="stock"><span><?php echo $lang_50; ?>:</span> 
                           <?php								
                              if(trim($v["stock"]) > 0){
                              	$stock=trim($v["stock"]);
                              ?>
                     ...
                     <div id="product">
                        ...
                        <div class="cart" id="recnt_cart" >
                           <button onclick="bid_now();" id="bid_now_button" style="background-color: #3498db;height:46px;" class="addToCart" type="button"  ><i class="fa fa-gavel fa-2x"></i> <span class="">Bid Now</span></button>
                           <?php
                        ...
                        <div class="form-group box-info-product">
                           ...
                           <div class="add-to-links wish_comp">
                              <ul class="blank list-inline">
								 ...
								 <!--  <li class="share">
                                    <a class="icon" data-toggle="tooltip" title=""
                                       href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url;?>product.php?id=<?php echo $_GET["id"];?>&amp;title=<?php echo $v['name']?>&amp;image=https://www.ouslet.com/vendor/product_photo/<?php echo $main_image;?>" target="_blank" data-original-title="<?php echo $lang_269;?>"><i class="fa fa-facebook"></i>
                                    </a>
                                 </li>
								  
								  <li class="share">
                                    <a class="icon" data-toggle="tooltip" title=""
                                       href="https://www.facebook.com/sharer/sharer.php?s=100&amp;p[title]=<?php  echo $v['name'];?>&amp;p[url]=<?php echo $url;?>product.php?id=<?php echo $_GET["id"];?>&amp;p[images][0]=https://www.ouslet.com/vendor/product_photo/<?php echo $main_image;?>" target="_blank" data-original-title="<?php echo $lang_269;?>"><i class="fa fa-facebook"></i>
                                    </a>
                                 </li>
								  -->
                                 <!--<li class="share">
                                    <a class="icon" data-toggle="tooltip" title=""
                                       href="https://twitter.com/home?status=<?php echo $url;?>product.php?id=<?php echo $_GET["id"];?>" target="_blank" data-original-title="<?php echo $lang_270;?>"><i class="fa fa-twitter"></i>
                                    </a>
                                 </li>-->
								  <li class="share">
                                    <a class="icon" data-toggle="tooltip" title=""
								 ...
								 <!-- <li class="share">
                                    <a class="icon" data-toggle="tooltip" title=""
                                       href="https://twitter.com/intent/tweet?url=<?php echo $url;?>product.php?id=<?php echo $_GET["id"];?>" target="_blank" data-original-title="<?php echo $lang_270;?>"><i class="fa fa-twitter"></i>
                                    </a>
                                 </li>-->
                              </ul>
                           </div>
                  ...
                  <div id="tab-review" class="tab-pane fade">
                     <form>
                        ...
                        <div class="contacts-form">
                           ...
                           <div class="buttons clearfix"><a id="button-review" class="btn buttonGray" onclick="submit_review('<?php echo $_GET["id"]; ?>');">Continue</a></div>
                        </div>
                     </form>
                  </div>
                  ...
                  <div id="tab-5" class="tab-pane fade">
                     <form>
                        ...
                        <div class="contacts-form">
                           ...
                           <div class="buttons clearfix"><a id="button-review" class="btn buttonGray" onclick="submit_question('<?php echo $_GET["id"]; ?>');">Continue</a></div>
                        </div>
                     </form>
                  </div>
               </div>
