                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a  href="product.php?id=<?php echo $v["ass_apa_id"] ?>"><img width="70px" src="vendor/product_photo/<?php echo $image; ?>" alt="<?php echo getProductName($v["ass_apa_id"]);  ?>" title="<?php echo getProductName($v["ass_apa_id"]);  ?>">
                           </a>
                        </td>
                        ...
                        <td class="text-center">
							...
							?>	
                           		<button class="btn btn-info" title="" data-toggle="tooltip" onclick="verification(<?php echo $v["ass_id"]; ?>)" >Verification</button>
                           	<?php
							}else{
							?>
