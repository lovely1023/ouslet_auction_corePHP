...
<div class="main-container container">
      <ul class="breadcrumb">
         ...
         <li><a href="">PayPal(Auction)</a></li>
      </ul>
      <div class="row">
         <!--Middle Part Start-->
         <div id="content" class="col-sm-12">
            <h2 class="title">PayPal(Auction)</h2>
			<div class="container" style="min-height: 500px;">
			    <div class="status">
			        ...
			        ?>
			            ...
			            <h1 style="font-size: 36px;text-align:center; color:#8B0000;  text-shadow: 2px 2px 2px grey;">Your Payment has been Successful</h1>

			            <h2 style="color:blue">Payment Information</h2>
						<div class="container" style="line-height: 36px; font-size:18px; text-color:grey">
				            <div class="col-xs-6">Reference Number</div> 	<div class="col-xs-6"><?php echo $_POST["receiver_id"]; ?></div>
				            <div class="col-xs-6">Transaction ID</div> 	<div class="col-xs-6"><?php echo $txn_id; ?></div>
				            <div class="col-xs-6">Paid Amount</div> 	 	<div class="col-xs-6"><?php echo $amount.$_POST["mc_currency"]; ?></div>
				            <div class="col-xs-6">Payment Status</div> 	<div class="col-xs-6"><?php echo $payment_status; ?></div>
			            </div>
			            
			            <h2 style="margin-top:24px; color:blue">Product Information</h2>
			            <div class="container" style="line-height: 36px; font-size:18px; text-color:grey">
			        ...
			        <?php }else{ ?>
			            <h1 class="error"  style="font-size: 36px;text-align:center; color:#8B0000;  text-shadow: 2px 2px 2px grey;">Your Payment has Failed</h1>
			        <?php } ?>
			    </div>
