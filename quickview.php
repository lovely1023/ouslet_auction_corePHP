            ...
            <div class="row">
               ...
               <div id="content" class="col-md-12 col-sm-12">
                  <?php
                     ...
                     $select="apa_id,apa_vr_id,name,category,sub_cat,sub_sub_cat,features,description,weight,color,brand,size,currency,price,status,video,stock,posting_type,listing_duration, view_count";
                           ...
                           <div class="content-product-left class-honizol col-sm-6 col-xs-12 ">
                              <div class="large-image  ">
                                 <?php
                                    ...
                                    ?>								
                                 <img itemprop="image" class="product-image-zoom" src="vendor/product_photo/<?php echo $main_image; ?>" data-zoom-image="vendor/product_photo/<?php echo $main_image; ?>" title="<?php echo $v["name"]; ?>" alt="<?php echo $v["name"]; ?>" style="cursor:zoom-in">
                              </div>
                              <?php
                                 if(trim($v["video"]) != ""){
                                 ?>
                           ...
                           <div class="content-product-right col-sm-6 col-xs-12">
                              ...
                              <div class="product-label form-group">
                                 ...
                                 <?php 
		                        			...
		                        			echo '<button class="label label-percent col-sm-6 col-xs-12" style="line-height:16px;border-style:none;">Last Bid : '.higest_bid($v["apa_id"]).' <br/> Bidder: '.$nick_name.'</button>';
                                  ...
                                  <?php
                                    ...
                                    <div class="reward" style="padding-bottom: 30px">
                                    	<div  class="col-sm-6 col-xs-12" style="padding-left: 0px !important"><span><?php echo $lang_92; ?>:</span> <?php  echo seeMoreDetails("company","vendor_registration",array("vr_id"=>$v["apa_vr_id"])); ?></div>
                                       	<div class="col-sm-6 col-xs-12"><span>Country: <?php  //echo $country_data[0]['cn_name']; ?><img src="image/flags/<?php echo strtolower($country_data[0]['cn_iso_code']);?>.png"  style="padding-left:10px;"/></span></div>
                                    </div>
									...
									?>
                                    	<div class="row">
                                    		<div class="col-sm-6 col-xs-12"><a href="" data-toggle="modal" data-target="#product_by_seller">All offers from the seller</a></div>
											<div class="col-sm-6 col-xs-12"><a href="" data-toggle="modal" data-target="#bid_history">Bid history</a></div>
											<div class="col-sm-6 col-xs-12"><a href="" data-toggle="modal" data-target="#auctioneer_list">List of auctioneers</a></div>
											<div class="col-sm-6 col-xs-12"><a href="" data-toggle="modal" data-target="#similar_auction_products">Show similar auction products</a></div>
