	...
	<div class="main-container container">
		...
		<div class="row">
			<div id="content" class="col-sm-12">
				<h2 class="title">Register Address</h2>
				<p>In order to be able to send you a product in case of winning the auction, it is necessary to add personal information.</p>
