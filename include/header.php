...
<html lang="en">
   <head>
      ...
      $find_info = strpos($page_info, 'about_us');
      if(strpos($page_info, 'about_us') > 0 && strpos($page_info, 'about_us') != false){
	  	$keywords_extra = "";
	  }
    
      if(strpos($page_info, '/ouslet/product.php') > 0){
	  	$keywords_extra = "";
	  }
                     ...
                     <ul class="top-link list-inline">
                        <li class="account" id="my_account">
                           ...
                           <ul class="dropdown-menu ">
                              ...
                              <li><a href="won_auction.php" ><i class="fa fa-pencil-square-o"></i> Won Auction</a></li>
                              <li><a href="purchase_auction.php" ><i class="fa fa-pencil-square-o"></i> Purchase Auction</a></li>
                              <li><a href="my_bid.php" ><i class="fa fa-pencil-square-o"></i> My Bid</a></li>
