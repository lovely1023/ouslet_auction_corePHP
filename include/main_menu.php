				...
				<div class="megamenu-pattern">
												...
												<div class="col-sm-12 list-product">
													<div class="product-thumb">
														<div class="image pull-left">
															<a href="product.php?id=<?php echo $v["apa_id"];  ?>"><img src="vendor/product_photo/<?php echo $image[0]["image"]; ?>" width="80" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive"></a>
														</div>
														<div class="caption">
															<h4><a href="product.php?id=<?php echo $v["apa_id"];  ?>"><?php echo getProductName($v["apa_id"]);  ?></a></h4>
					...
					?>
												...
												<!--<div class="row  list-product">-->
													<div class="product-thumb">
														<div class="image pull-left">
															<a href="product.php?id=<?php echo $v["apr_apa_id"];  ?>"><img src="vendor/product_photo/<?php echo $image[0]["image"]; ?>" width="80" alt="" title="" class="img-responsive"></a>
														</div>
														<div class="caption">
															<h4><a href="product.php?id=<?php echo $v["apr_apa_id"];  ?>"><?php echo getProductName($v["apr_apa_id"]);  ?></a></h4>
											...
											<div class="col-md-4">
												<div class="row" style="padding-top:5px;padding-left:15px;">
													...
													<div class="col-sm-12 list-product">
														<div class="product-thumb">
															<div class="image pull-left">
																<a href="product.php?id=<?php echo $v["apr_apa_id"];  ?>"><img src="vendor/product_photo/<?php echo $image[0]["image"]; ?>" width="80" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive"></a>
															</div>
															<div class="caption">
																<h4><a href="product.php?id=<?php echo $v["apr_apa_id"];  ?>"><?php echo getProductName($v["apr_apa_id"]);  ?></a></h4>
