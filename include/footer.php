						...
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="menu">
									...
									<li><a href="for_buyers.php">For Buyers</a></li>
									<li><a href="for_sellers.php">For Sellers</a></li>
						...
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="contact-address">
									<li style="padding-top:8px;"><span class="fa fa-map-marker"></span><?php  echo get_site_settings(28); ?></li>
									<li style="padding-top:8px;"><span class="fa fa-envelope-o" style="margin-top:0px!important;"></span> <?php echo $lang_113; ?>: <a href="mailto:<?php  echo get_site_settings(23); ?>"><?php  echo get_site_settings(23); ?></a></li>
									<li style="padding-top:8px;"><span class="fa fa-phone" style="margin-top:0px!important;"></span> <?php echo $lang_59; ?> : <?php  echo get_site_settings(22); ?></li>
								</ul>
							</div>
						</div>
					</div>
